    ...
    - 선택 이유
        - nosql vs sql
            ...
            - ‘검색’이기에 select 쿼리를 주로 사용: Id로 읽는 경우는 mongodb가 매우 빠르지만 그게 아닌 ‘검색’은 mongodb와 10ms 정도 차이만 있음
                ![%E1%84%89%E1%85%B3%E1%84%8F%E1%85%B3%E1%84%85%E1%85%B5%E1%86%AB%E1%84%89%E1%85%A3%E1%86%BA_2024-12-11_%E1%84%8B%E1%85%A9%E1%84%8C%E1%85%A5%E1%86%AB_11 24 41](https://github.com/user-attachments/assets/9a2a5368-0ec0-4f48-9e22-3ed93059be75)

                [https://www.youtube.com/watch?v=bluQwqMgTsw&t=674s](https://www.youtube.com/watch?v=bluQwqMgTsw&t=674s)
...
- 2025.03.06: 프리티어 기간이 지나 aws 계정 마이그레이션(S3)
    
    s3는 chatgpt와 간단 해결
    
    [[AWS] RDS 인스턴스 다른 계정으로 이관하기 (프리티어)](https://programforlife.tistory.com/108)
    
- 2025.03.07~2024.03.10: aws 계정 마이그레이션(rds)
...
- 2025.03.11: `useState` 를 사용하지 않고 SSR 방식으로 검색 구현, detail 페이지 blur skeleton
    1. 검색 기능
        - 참고 공식문서
...
- 2025.03.12: tailwind와 책장 조감도 이용하여 특정 위치 표시, 세부 정보는 제거
...
- 2025.03.13: tailwind 초기 테마 세팅 및 SearchResults 스타일링 in feat/styles branch
    - tailwind 초기 테마 세팅
...
- 2025.03.17: 모바일 사이즈에 맞도록 반응형 사이즈 조절(텍스트, 여백)
    - vw, px, rem 등을 이용
    - 계산 방식이 동일해서 유틸 함수로 만들어 tailwind className으로 사용하려고 하다가 그게 tailwind에서 인식을 못하므로 취소함
- 2025.03.18~2025.03.19: parallel route로 만든 모달 형태로 위치 표시하도록 변경
...
- 2025.03.20: 스크롤바 삭제
- 2025.03.21~2025.03.24: 인터셉팅 Route로 hard navigation에 대응
...
- 2025.03.25~2025.0327: 동적/정적 메타데이터(metadata) 적용
